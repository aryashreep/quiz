                        ...
                        <form method="post" action="">
                            <div class="card-body p-md-5 text-black">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div data-mdb-input-init class="form-outline">
                                            ...
                                            <input type="text" id="form3Example1m1" class="form-control form-control-lg"
                                                name="initiated_name" placeholder="Your Initiated name!" />
                                        </div>
                                    </div>
                                </div>

                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form3Example8">Phone Number (format:
                                        xxxxxxxxxx):</label>
                                    <input type="text" id="form3Example8" name="phone_no"
                                        class="form-control form-control-lg" placeholder="Enter your Phone no!"
                                        pattern="^\d{10}$" required />
                                </div>

                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form3Example8">Password:</label>
                                    <input type="text" id="form3Example8" name="password"
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <select class="form-control form-control-lg form-select" name="centers"
                                ...
                                <div class="d-flex justify-content-end pt-3">
                                    ...
                                    <input name="firstname" type="text" id="firstname" autocomplete="random_value"
                                        class="hide-robot">
                                    <!-- honeypot fields end -->
